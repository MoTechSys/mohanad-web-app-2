 ...
 */
var ENABLE_SW = process.env.VITE_ENABLE_SW !== 'false';
export default defineConfig({
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          },
          {
            urlPattern: (_a) => {
              var url = _a.url;
              return url.pathname.startsWith('/health');
            },
            handler: 'NetworkOnly',
  ...
  server: {
    ...
    proxy: {
      '/api': {
        target:
          (_a = process.env.VITE_API_URL) !== null && _a !== void 0 ? _a : 'http://localhost:3001',
        changeOrigin: true,
      },
      '/health': {
        target:
          (_b = process.env.VITE_API_URL) !== null && _b !== void 0 ? _b : 'http://localhost:3001',
        changeOrigin: true,
      },
    },
  },
